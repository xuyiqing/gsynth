...
cumulative abnormal returns in event study. We add a simple 
function `effect`` to calculate cumulative treatment effects. One can specify 
...
One can also calculate ATT for a sub-group by specifying 
