...
Manual](https://yiqingxu.org/packages/gsynth/) has worked examples with
code.
...
**gsynth** is now a wrapper of **fect**. Please check [fect User
Manual](https://yiqingxu.org/packages/fect/) for updates. We maintain
