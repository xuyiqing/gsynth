...
The plot is drawn by **panelView** from the data given to `gsynth()`: white cells are missing observations, and units that `gsynth()` removed for having fewer than `min.T0` pre-treatment periods still appear. The status used in estimation is in `out$obs.missing`: `1` = under treatment, `2` = not under treatment (control units, and treated units before treatment), `3` = missing, `4` = unit removed, `5` = placebo period.
