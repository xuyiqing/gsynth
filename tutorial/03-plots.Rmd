...
White cells are missing observations; gray with red dots are observations removed due to insufficient pre-treatment periods. The matrix is also available in `out$obs.missing`, where `1` = treated, `2` = not under treatment (controls, and treated units before treatment), `3` = missing, `4` = removed, `5` = placebo.
