...
The output reports `sigma2` (error variance), `IC` (information criterion), and `MSPE` (mean squared prediction error). Cross-validation picks `r` by the rule in `cv.rule`. The default, `"1se"`, picks the smallest `r` whose MSPE is within one standard error of the lowest MSPE.
